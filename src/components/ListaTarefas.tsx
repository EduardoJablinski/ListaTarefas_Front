...
const TarefaItem: React.FC<TarefaItemProps> = ({ id, tarefa }) => {
  ...
  return (
    <Box flexDirection="row" justifyContent="space-between" alignItems="center" bg="gray.300" p={4} my={2} mx={2} borderRadius={8}>
      {editando ? (
      ...
      <IconButton
        icon={<Ionicons name={editando ? "checkmark" : "pencil"} size={14} color="#77434" />}
